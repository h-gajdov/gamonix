...
dice_values = (1, 1)
dice_values_ui = (1, 1)
AI_AGENT = agent.AdaptiveBeamAgent(color=LIGHT_PIECE, config=configs['41gensnodoubles'], max_depth=1, play_opening=True)
PLAYER_AGENT = agent.AdaptiveBeamAgent(color=DARK_PIECE, config=configs['41gensnodoubles'], max_depth=2, play_opening=True)
players = [AI_AGENT, PLAYER_AGENT]
